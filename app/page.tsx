    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4 font-sans">
      <main className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border border-gray-100 text-center">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 mb-8">
          ...
          <div className="mb-6">
            <Link href="/privacy" className="text-xs text-blue-600 underline hover:text-blue-800 flex items-center justify-center gap-1">
              <span>📄</span>
              個人情報保護方針の詳細を確認する
            </Link>
          </div>
          ...
          <div className="space-y-3">
            <Link href="/resume/1" className="block">
