    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <section className="space-y-4 rounded-md border border-gray-200 p-4">
          <h3 className="text-base font-semibold text-gray-800">本人情報</h3>
        ...
        <section className="space-y-4 rounded-md border border-gray-200 p-4">
          <h3 className="text-base font-semibold text-gray-800">連絡先</h3>
          ...
          <div className="space-y-3 rounded-md border border-dashed border-gray-300 bg-gray-50 p-3">
        ...
        <details className="rounded-md border border-gray-200 p-4">
          <summary className="cursor-pointer text-sm font-semibold text-gray-800">任意項目</summary>
          <p className="mt-1 text-xs text-gray-500">あとからでも入力できます。</p>
